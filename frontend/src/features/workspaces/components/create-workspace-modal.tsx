    ...
    <div className="fixed inset-0 z-[var(--z-overlay)] flex items-center justify-center bg-black/75 backdrop-blur-[2px] animate-fade-in select-none">
      ...
      >
        ...
        <div className="flex items-center justify-between pb-3.5 border-b border-slate-200 dark:border-slate-800/60">
          <h3 className="text-sm font-semibold text-slate-900 dark:text-foreground">Create Workspace</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-4">
          <div className="space-y-1">
            ...
            >
              Workspace Name<span className="text-rose-500 ml-0.5">*</span>
            </label>
            <input
              id="name"
              type="text"
          ...
          <div className="space-y-1">
            <label
              ...
              className="block text-[11px] font-bold text-slate-500 dark:text-muted-foreground uppercase tracking-wide"
            >
              Workspace URL Slug<span className="text-rose-500 ml-0.5">*</span>
            </label>
            <div className="flex rounded-lg border border-slate-200 dark:border-slate-800 bg-[#F4F6F8] dark:bg-[#050608] focus-within:ring-1 focus-within:ring-primary/40 focus-within:border-primary/40 transition-all overflow-hidden h-9">
              <span className="flex items-center text-slate-500 dark:text-muted-foreground/60 text-xs px-3 bg-slate-100 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 font-medium shrink-0">
                /workspaces/
              </span>
              <input
                id="slug"
                type="text"
                className="w-full text-xs px-3 bg-transparent border-0 text-slate-950 dark:text-foreground placeholder-slate-400 dark:placeholder-muted-foreground/60 focus:outline-none"
